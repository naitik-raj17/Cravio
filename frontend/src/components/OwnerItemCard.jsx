  ...
  return (
    <div className='flex bg-white rounded-lg shadow-md overflow-hidden border border-[#ff4d2d] w-full max-w-2xl'>
      ...
      <div className='flex flex-col justify-between p-3 flex-1'>
            ...
            <div className='p-2 cursor-pointer rounded-full hover:bg-[#ff4d2d]/10 flex items-center text-[#ff4d2d]' onClick={()=>navigate(`/edit-item/${data._id}`)}>
            <FaPen size={16}/>
            </div>
              <div className='p-2 cursor-pointer rounded-full hover:bg-[#ff4d2d]/10 flex items-center text-[#ff4d2d]' onClick={()=>handleDelete()}>
            <FaTrashAlt size={16}/>
              </div>
            </div>
