          ...
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              ...
              <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                Join Cravio platform and reach thousands of hungry customers every day
              </p>
...

      {
        ...
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
              <div className='absolute top-4 right-4 bg-[#ff4d2d] text-white p-2 rounded-full shadow-medium hover:bg-orange-600 transition-colors cursor-pointer' onClick={()=>navigate("/create-edit-shop")}>
                <FaPen size={20}/>
              </div>
          ...
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              ...
              <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                Share your delicios creations with our customers by adding them to the menu.
              </p>
          ...
          >
            {myShopData.items.map((item) => (
              <OwnerItemCard data={item} key={item._id ?? item.id} />
            ))}
            </div>}
        </div>}
    </div>
